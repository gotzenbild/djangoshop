...
class Order(models.Model):
    ...
    sticker = models.CharField(max_length=40, default="Звичайний")
    payment = models.CharField(max_length=40, default="Повна")
    datep = models.CharField(max_length=40, default="Ближайший")
